...
.submit-button {
  background-color: rgba(239, 188, 155, 1);
  align-self: center;
  margin-top: 57px;
  width: 733px;
  max-width: 100%;
...
<section class="feedback-container">
  ...
  <main class="main-content">
    ...
    <form class="feedback-form">
      ...
      <input type="number" id="rating-scale" name="rating-scale" min="1" max="10" class="rating-scale-input" placeholder="Mehrab" aria-label="Rate the product from 1 to 10">
